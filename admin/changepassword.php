...
$newpassword=crypt($_POST['newpassword'],'st');
$username=$_SESSION['alogin'];
$uname= getEncryptedUser(username);
$pass = getEncryptedPass(password);
connect($uname,$pass);
    $sql ="SELECT Password FROM admin WHERE UserName=:$uname and Password=:$pass";
